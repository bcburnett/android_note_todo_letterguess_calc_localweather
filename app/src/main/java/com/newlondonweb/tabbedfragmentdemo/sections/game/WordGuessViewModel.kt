package com.newlondonweb.tabbedfragmentdemo.sections.game
...
import com.newlondonweb.tabbedfragmentdemo.sections.game.letters.Command
import com.newlondonweb.tabbedfragmentdemo.sections.game.letters.Phrases
...
class WordGuessViewModel(application: Application) : AndroidViewModel(application) {
    ...
    companion object {
        @Volatile
        private var INSTANCE: WordGuessViewModel? = null
        fun newInstance(application: Application): WordGuessViewModel {
            if (INSTANCE != null) return INSTANCE as WordGuessViewModel
            synchronized(this) {
                INSTANCE = WordGuessViewModel(application)
                return INSTANCE as WordGuessViewModel
            }
        }
    }
