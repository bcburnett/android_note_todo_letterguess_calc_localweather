...
public final class DataXXXX {
    ...
    public DataXXXX(double apparentTemperatureHigh, int apparentTemperatureHighTime, double apparentTemperatureLow, int apparentTemperatureLowTime, double apparentTemperatureMax, int apparentTemperatureMaxTime, double apparentTemperatureMin, int apparentTemperatureMinTime, double cloudCover, double dewPoint, double humidity, @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.newlondonweb.tabbedfragmentdemo.data.weather.DataXXXX copy(double apparentTemperatureHigh, int apparentTemperatureHighTime, double apparentTemperatureLow, int apparentTemperatureLowTime, double apparentTemperatureMax, int apparentTemperatureMaxTime, double apparentTemperatureMin, int apparentTemperatureMinTime, double cloudCover, double dewPoint, double humidity, @org.jetbrains.annotations.NotNull()
    java.lang.String icon, double moonPhase, double ozone, double precipIntensity, double precipIntensityMax, int precipIntensityMaxTime, double precipProbability, @org.jetbrains.annotations.NotNull()
    java.lang.String precipType, double pressure, @org.jetbrains.annotations.NotNull()
    java.lang.String summary, int sunriseTime, int sunsetTime, double temperatureHigh, int temperatureHighTime, double temperatureLow, int temperatureLowTime, double temperatureMax, int temperatureMaxTime, double temperatureMin, int temperatureMinTime, int time, int uvIndex, int uvIndexTime, int visibility, int windBearing, double windGust, int windGustTime, double windSpeed) {
        return null;
